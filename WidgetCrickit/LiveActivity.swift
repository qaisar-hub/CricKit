            ...
            HStack {
                ...
                HStack(spacing: 5){
                    Text(context.attributes.leftTeamName)
                        .font(.subheadline)
                        .foregroundColor(colorScheme == .dark ? Color.white : Color.black)
                    Text(context.attributes.leftTeamRuns.isEmpty ? "Yet to Bat" : "\(context.attributes.leftTeamRuns)/\(context.attributes.leftTeamWickets)")
                        .font(.subheadline)
                        .foregroundColor(colorScheme == .dark ? Color.white : Color.black)
                    Spacer()
                    Text("\(context.attributes.leftTeamOvers) overs")
                        .font(.subheadline)
                        .foregroundColor(colorScheme == .dark ? Color.white : Color.black)
                }
            }
            ...
            HStack {
                ...
                HStack(spacing: 5){
                    Text(context.attributes.rightTeamName)
                        .font(.subheadline)
                        .foregroundColor(colorScheme == .dark ? Color.white : Color.black)
                    Text(context.attributes.rightTeamRuns.isEmpty ? "Yet to Bat" : "\(context.attributes.rightTeamRuns)/\(context.attributes.rightTeamWickets)")
                        .font(.subheadline)
                        .foregroundColor(colorScheme == .dark ? Color.white : Color.black)
                    Spacer()
                    Text("\(context.attributes.rightTeamOvers) overs")
                        .font(.subheadline)
                        .foregroundColor(colorScheme == .dark ? Color.white : Color.black)
                }
            }
